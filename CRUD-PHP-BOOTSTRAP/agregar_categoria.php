...
<form action="_insertar_categoria.php" method="post"  >
	<label >Categoria</label>
	<div class="form-group">
		<input type="text" name="categoria" class="form-control" placeholder="Digite el nombre de la categoria" autocomplete="off">
	</div>
	<div style="text-align: right;">
